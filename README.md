...
1- Doll turns back till countdown stop , player can move during that time
2- Doll turns front till countdown starts, player cannot move 
3-If player breaks one of these rules it is game over!
